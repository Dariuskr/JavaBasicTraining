...
public class Main {
    ...
    public static void main(String[] args) {
        //HelloWorld uzduotis0 = new HelloWorld();
        // uzduotis0.HelloWorldd();
        // SalygosSakiniai naujas = new SalygosSakiniai();
        // naujas.Uzduotysv2();
       // Pasirinkimai naujas1 = new Pasirinkimai();
       // naujas1.switchas();

       // WhileCiklas begalinisBreak = new WhileCiklas();
       // begalinisBreak.Nesibaigiantis();
